...
const Home = () => {
  ...
  return (
    <div className="bg-purple-900 min-h-screen">
     ...
     {/* Home Section */}
<section id="home" className="py-20 w-full bg-violet-950">
  <div className="flex flex-col-reverse md:flex-row items-center justify-between max-w-5xl mx-auto">
    ...
    <div className="text-white px-6 md:px-12 lg:px-20 max-w-xl text-left">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mt-2 leading-tight">
        Ubaid Raza
      </h1>
      <h2 className="text-orange-400 text-xl sm:text-2xl md:text-3xl font-semibold mt-4">
      ...
      <div className="flex justify-start space-x-4 mt-6">
        <a href="#facebook" className="text-white hover:text-orange-500 text-lg sm:text-xl">
          <i className="fab fa-facebook-f"></i>
        </a>
        <a href="#linkedin" className="text-white hover:text-orange-500 text-lg sm:text-xl">
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="#twitter" className="text-white hover:text-orange-500 text-lg sm:text-xl">
          <i className="fab fa-twitter"></i>
        </a>
        <a href="#instagram" className="text-white hover:text-orange-500 text-lg sm:text-xl">
    ...
    <div className="mt-10 md:mt-0 flex justify-center">
      <img
        ...
        alt="Your Image"
        className="w-64 sm:w-72 md:w-80 lg:w-96 h-auto object-cover rounded-lg shadow-lg"
      />
    </div>
  </div>
</section>
...
<section id="about" className="bg-violet-950 py-20">
  <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 sm:px-12 lg:px-20">
    {/* Image Section */}
...
<section id="work" className="bg-purple-900 py-20">
  <div className="text-center px-6 sm:px-12 lg:px-20">
    <h2 className="text-3xl sm:text-4xl font-bold text-gray-50">My Work</h2>
...
<section id="skills" className="bg-purple-800 py-20">
  <div className="text-center px-6 sm:px-12 lg:px-20 mb-8">
    <h2 className="text-3xl sm:text-4xl font-bold text-gray-50">
      My <span className="text-orange-400">Skills</span>
    </h2>
  </div>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-6 sm:px-12 lg:px-20">
...
<section id="contact" className="bg-violet-900 py-20">
  <div className="text-center mb-10 px-6 sm:px-12 lg:px-20">
    <h2 className="text-3xl sm:text-4xl font-bold text-gray-50">
  ...
  <div className="max-w-4xl mx-auto px-6 sm:px-12 lg:px-20">
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <textarea
        ...
        required
        className="col-span-1 md:col-span-2 py-3 px-4 h-32 rounded-lg bg-purple-700 text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
      ></textarea>
      <button
        type="submit"
        className="col-span-1 md:col-span-2 py-3 px-6 bg-orange-500 text-white font-bold rounded-lg hover:bg-orange-600 transition"
    ...
    <div className="text-center mt-10 text-gray-300">
      <p>
        Call Us: <span className="text-orange-500">+923172046095</span>
      </p>
      <p>
        Email: <span className="text-orange-500">ubairaza200@gmail.com</span>
      </p>
    </div>
  </div>
</section>
